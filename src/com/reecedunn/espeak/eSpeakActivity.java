        ...
        findViewById(R.id.speak).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    //Log.d(mTts.setLanguage("vi"),"ying 999");
                    // final Locale CANADA_FRENCH = createConstant("fr", "CA");
                    ...
                    mTts.setLanguage(Locale.getISOLanguages().toString()
                    mTts.speak("nha toi",TextToSpeech.QUEUE_ADD, null, null);
                } else {
